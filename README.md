...
Cooler, como função de atuador;
Sensor de temperatura (DHT11) e encoder do cooler;
ATMega328 (Arduíno UNO), como controlador;
Protoboard, Transistor, Cabos, Conectores e Fonte USB completam a lista de
materiais.
